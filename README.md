...
allows reconstructing the data model of a web page by mapping DOM elements to model props using user defined model mapping files. It supports mapping a single model or collection, as well as recursive mapping for props that represent other models or collections.
